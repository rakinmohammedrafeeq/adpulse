namespace AdPulse.Strategies.Targeting.Matchers
...
open AdPulse.Core.Shared.Entities
...
module private BehaviorHelpers =
    ...
    let hasBurst
        (records: IReadOnlyList<AdPulse.Core.Domain.Targeting.BehaviorRecord>)
        (window: TimeSpan)
        (threshold: int)
        =
            ...
            Task.Run(fun () ->
                ...
                try
                    if ct.IsCancellationRequested then
                        ...
                        let behaviors = ResizeArray<AdPulse.Core.Domain.Targeting.BehaviorRecord>()
                        ...
                        if context :? UserBehavior then
                            ...
                            then
                                behaviors.Add(
                                    AdPulse.Core.Domain.Targeting.BehaviorRecord(
                                        ub.BehaviorType,
                                        ub.BehaviorValue,
                        ...
                        if behaviors.Count = 0 then
                            ...
                            if matches.Length = 0 then
                                ...
                                // 5) 行为“爆发”模式
                                let asList: IReadOnlyList<AdPulse.Core.Domain.Targeting.BehaviorRecord> =
                                    let l =
