...
using AdPulse.Infrastructure.Common.Base;
using Microsoft.Extensions.Diagnostics.HealthChecks;
using Xunit;

namespace AdPulse.Infrastructure.Common.Tests.Base;
...
public class HealthCheckableComponentBaseTests
{
    ...
    public void HealthCheckableComponentBase_Should_Inherit_From_ComponentBase()
    {
        ...
        component.Should().BeAssignableTo<AdPulse.Infrastructure.Common.Abstractions.IHealthCheckable>();
