module AdPulse.Strategies.Targeting.Tests.Matchers.UserPreferenceMatcherTests
...
let matcher =
    UserPreferenceMatcher() :> AdPulse.Core.AdEngine.Abstractions.Interfaces.ITargetingMatcher
