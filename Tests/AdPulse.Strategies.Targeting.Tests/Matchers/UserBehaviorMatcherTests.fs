module AdPulse.Strategies.Targeting.Tests.Matchers.UserBehaviorMatcherTests

open System
open System.Threading
open Xunit
open FsUnit.Xunit
open AdPulse.Strategies.Targeting.Matchers
open AdPulse.Core.AdEngine.Abstractions.Interfaces
open AdPulse.Core.AdEngine.Abstractions.Models
open AdPulse.Core.Domain.Targeting
...
let mkRecord (t: string) (v: string) (ts: DateTime) (freq: int) (w: decimal) (ctx: string) =
    AdPulse.Core.Domain.Targeting.BehaviorRecord(t, v, ts, freq, w, ctx)

let toIList
    (items: AdPulse.Core.Domain.Targeting.BehaviorRecord list)
    : IList<AdPulse.Core.Domain.Targeting.BehaviorRecord> =
    upcast new List<AdPulse.Core.Domain.Targeting.BehaviorRecord>(items)
